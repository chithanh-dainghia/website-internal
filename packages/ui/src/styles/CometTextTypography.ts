import { isPlatform, isBrowser, isEngine } from "@ui/utils/user-agent";
...
export type TypeKeys = keyof typeof TYPORAPHY_STYLES;

function calculateOffset() {
  if (isPlatform("Windows >= 6"))
    // return { fontFamily: FONT_FAMILY.segoe, offsets: offsets3 };
    return { fontFamily: "segoe", offsets: offsets3 };
