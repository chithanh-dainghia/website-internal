...
function rc(a,b,c,d,e,g,f){switch(b){case "div":case "span":case "svg":case "path":case "a":case "g":case "p":case "li":break;case "select":a.push(U("select"));var m=null,n=null,t;for(t in c)if(z.call(c,t)){var v=c[t];if(null!=v)switch(t){case "children":m=v;break;case "dangerouslySetInnerHTML":n=v;break;case "defaultValue":case "value":break;default:O(a,t,v)}}a.push(T);cc(a,n,m);return m;case "option":var p=g.selectedValue;a.push(U("option"));var w=null,H=null,I=null,F=null,u;for(u in c)if(z.call(c,
u)){var P=c[u];if(null!=P)switch(u){case "children":w=P;break;case "selected":I=P;break;case "dangerouslySetInnerHTML":F=P;break;case "value":H=P;default:O(a,u,P)}}if(null!=p){var Q=null!==H?""+H:dc(w);if(Ma(p))for(var L=0;L<p.length;L++){if(""+p[L]===Q){a.push(ec);break}}else""+p===Q&&a.push(ec)}else I&&a.push(ec);a.push(T);cc(a,F,w);return w;case "textarea":a.push(U("textarea"));var B=null,R=null,C=null,D;for(D in c)if(z.call(c,D)){var ja=c[D];if(null!=ja)switch(D){case "children":C=ja;break;case "value":B=
...
function qe(a,b,c){me=!1;ne=!0;b.forEach(oe,a);me&&(c.stylesToHoist=!0);return ne}function re(a){if(0===(a.state&7)){for(var b=a.chunks,c=0;c<b.length;c++)q(this,b[c]);a.state|=1}}function se(a){if(0===(a.state&7)){for(var b=a.chunks,c=0;c<b.length;c++)q(this,b[c]);a.state|=2}}var te=null,ue=!1;function ve(a,b,c){b=a.chunks;if(a.state&3)c.delete(a);else if("style"===a.type)te=a;else{E(b,a.props);for(c=0;c<b.length;c++)q(this,b[c]);a.state|=1;ue=!0}}
...
function Be(a){if(!(a.state&8)&&"style"!==a.type){var b=a.chunks,c=a.props;E(b,{rel:"preload",as:"style",href:a.props.href,crossOrigin:c.crossOrigin,fetchPriority:c.fetchPriority,integrity:c.integrity,media:c.media,hrefLang:c.hrefLang,referrerPolicy:c.referrerPolicy});for(c=0;c<b.length;c++)q(this,b[c]);a.state|=8;b.length=0}}function Ce(a){a.forEach(Be,this);a.clear()}var De=y("["),Ee=y(",["),Fe=y(","),Ge=y("]");
...
q(e,x(A(JSON.stringify(m))))}}}q(a,Ge);c=Ee;d.state|=2}});q(a,Ge)}function Qa(a){var b=V?V:null;if(b){var c=b.resources;if("string"===typeof a&&a){var d="[prefetchDNS]"+a,e=c.preconnectsMap.get(d);e||(e={type:"preconnect",chunks:[],state:0,props:null},c.preconnectsMap.set(d,e),E(e.chunks,{href:a,rel:"dns-prefetch"}));c.preconnects.add(e);Je(b)}}}
function Ra(a,b){var c=V?V:null;if(c){var d=c.resources;if("string"===typeof a&&a){b=null==b||"string"!==typeof b.crossOrigin?null:"use-credentials"===b.crossOrigin?"use-credentials":"";var e="[preconnect]["+(null===b?"null":b)+"]"+a,g=d.preconnectsMap.get(e);g||(g={type:"preconnect",chunks:[],state:0,props:null},d.preconnectsMap.set(e,g),E(g.chunks,{rel:"preconnect",href:a,crossOrigin:b}));d.preconnects.add(g);Je(c)}}}
...
referrerPolicy:b.referrerPolicy}},d.preloadsMap.set(g,f),E(f.chunks,f.props));"font"===e?d.fontPreloads.add(f):"image"===e&&"high"===b.fetchPriority?d.highImagePreloads.add(f):d.bulkPreloads.add(f);Je(c)}}}
function ib(a,b){var c=V?V:null;if(c){var d=c.resources;if("string"===typeof a&&a){var e=b&&"string"===typeof b.as?b.as:"script",g="["+e+"]"+a,f=d.preloadsMap.get(g);f||(f={type:"preload",chunks:[],state:0,props:{rel:"modulepreload",as:"script"!==e?e:void 0,href:a,crossOrigin:b?b.crossOrigin:void 0,integrity:b?b.integrity:void 0}},d.preloadsMap.set(g,f),E(f.chunks,f.props));d.bulkPreloads.add(f);Je(c)}}}
...
c.insertionMode){a.responseState.hasBody=!0;break a}break;case "html":if(0===c.insertionMode)break a}b.push(kc,x(d),lc)}f.lastPushedText=!1}else{switch(d){case bf:case $e:case Pe:case Qe:case Oe:Z(a,b,null,e.children,0);return;case af:"hidden"!==e.mode&&Z(a,b,null,e.children,0);return;case We:Z(a,b,null,e.children,0);return;case Ze:Z(a,b,null,e.children,0);return;case Ve:a:{d=b.blockedBoundary;c=b.blockedSegment;g=e.fallback;e=e.children;var m=new Set,n={id:null,rootSegmentID:-1,parentFlushed:!1,
pendingTasks:0,forceClientRender:!1,completedSegments:[],byteSize:0,fallbackAbortableTasks:m,errorDigest:null,resources:new Set},t=pg(a,c.chunks.length,n,c.formatContext,!1,!1);c.children.push(t);c.lastPushedText=!1;var v=pg(a,0,null,c.formatContext,!1,!1);v.parentFlushed=!0;b.blockedBoundary=n;b.blockedSegment=v;a.resources.boundaryResources=n.resources;try{if(xg(a,b,e,0),v.lastPushedText&&v.textEmbedded&&v.chunks.push(Hb),v.status=1,yg(n,v),0===n.pendingTasks)break a}catch(p){v.status=4,n.forceClientRender=
...
p.status=1;Bg(t,n.blockedBoundary,p)}catch(C){Wf();p.children.length=w;p.chunks.length=H;var F=C===Bf?Ff():C;if("object"===typeof F&&null!==F&&"function"===typeof F.then){var u=n.ping;F.then(u,u);n.thenableState=Xf()}else{n.abortSet.delete(n);p.status=4;var P=void 0,Q=t,L=n.blockedBoundary,B=F;"object"===typeof B&&null!==B&&B.$$typeof===ff?(Q.onPostpone(B.message),P="POSTPONE"):P=sg(Q,B);null===L?tg(Q,B):(L.pendingTasks--,L.forceClientRender||(L.forceClientRender=!0,L.errorDigest=P,L.parentFlushed&&
...
var I=g.preloadChunks;for(f=0;f<I.length;f++)q(b,I[f]);I.length=0;var F=g.hoistableChunks;for(f=0;f<F.length;f++)q(b,F[f]);F.length=0;v&&null===p&&(q(b,kc),q(b,x("head")),q(b,lc));Fg(a,b,d);a.completedRootSegment=null;sc(b,a.responseState)}else return;else if(0<a.pendingRootTasks)return;var u=a.resources,P=a.responseState;d=0;u.preconnects.forEach(se,b);u.preconnects.clear();var Q=P.preconnectChunks;for(d=0;d<Q.length;d++)q(b,Q[d]);Q.length=0;u.fontPreloads.forEach(se,b);u.fontPreloads.clear();u.highImagePreloads.forEach(re,
...
m)};f.addEventListener("abort",m)}}g.flushScheduled=null!==g.destination;rg(g)})};exports.version="18.3.0-experimental-98f3f14d2-20230818";
