        ...
        if (
          ...
          if (typeof props.charSet === 'string') {
            ...
            return pushSelfClosing(
              responseState.preconnectChunks,
              props,
              'meta',
            )
          } else {
      ...
      if (typeof href === 'string' && href) {
        ...
        if (!resource) {
          resource = {
            ...
            chunks: [],
            state: NoState,
            props: preloadModulePropsFromPreloadModuleOptions(
              href,
              as,
              options,
            ),
          ...
          case 'style': {
            ...
            if (!resource) {
              ...
              resource = {
                ...
                chunks: [],
                state: state,
                props: stylesheetPropsFromPreinitOptions(
                  href,
                  precedence,
                  options,
                ),
        ...
        switch (_as) {
          case 'script': {
            ...
            if (!resource) {
              ...
              var resourceProps = modulePropsFromPreinitModuleOptions(
                src,
                options,
              )
              resources.scripts.add(resource)
