 ...
 */
'use strict';var aa=require("stream"),ba=require("util"),fa=require("async_hooks"),pa=require("react"),qa=require("react-dom");function ra(a){"function"===typeof a.flush&&a.flush()}var h=null,k=0,sa=!0;
...
typeof n||null==n.crossOrigin?void 0:"use-credentials"===n.crossOrigin?"use-credentials":"";var H=a,I={rel:"preload",href:f,as:"script",fetchPriority:"low",nonce:c,integrity:u,crossOrigin:n},F={type:"preload",chunks:[],state:0,props:I};H.preloadsMap.set("[script]"+f,F);H.bootstrapScripts.add(F);z(F.chunks,I);m.push(yb,y(f));c&&m.push(Ab,y(c));u&&m.push(Bb,y(u));"string"===typeof n&&m.push(Cb,y(n));m.push(Db)}if(void 0!==g)for(e=0;e<g.length;e++)u=g[e],d="string"===typeof u?u:u.src,f="string"===typeof u?
...
y((""+e).trim());c?(c=!1,a.push(Nb,g,Ob,e)):a.push(Pb,g,Ob,e)}}c||a.push(E)}var G=w(" "),J=w('="'),E=w('"'),Rb=w('=""');function Sb(a,b,c){c&&"function"!==typeof c&&"symbol"!==typeof c&&a.push(G,b,Rb)}function K(a,b,c){"function"!==typeof c&&"symbol"!==typeof c&&"boolean"!==typeof c&&a.push(G,b,J,y(c),E)}function Tb(a){var b=a.nextSuspenseID++;return a.idPrefix+b}var Ub=w(y("javascript:throw new Error('A React form was unexpectedly submitted.')")),Vb=w('<input type="hidden"');
...
5);if("data-"!==d&&"aria-"!==d)return}a.push(G,b,J,y(c),E)}}}var N=w(">"),cc=w("/>");function S(a,b,c){if(null!=b){if(null!=c)throw Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");if("object"!==typeof b||!("__html"in b))throw Error("`props.dangerouslySetInnerHTML` must be in the form `{__html: ...}`. Please visit https://reactjs.org/link/dangerously-set-inner-html for more information.");b=b.__html;null!==b&&void 0!==b&&a.push(""+b)}}
...
c.insertionMode){a.responseState.hasBody=!0;break a}break;case "html":if(0===c.insertionMode)break a}b.push(mc,d,nc)}f.lastPushedText=!1}else{switch(d){case ff:case df:case Te:case Ue:case Se:Y(a,b,null,e.children,0);return;case ef:"hidden"!==e.mode&&Y(a,b,null,e.children,0);return;case $e:Y(a,b,null,e.children,0);return;case cf:Y(a,b,null,e.children,0);return;case Ze:a:{d=b.blockedBoundary;c=b.blockedSegment;g=e.fallback;e=e.children;var l=new Set,m={id:null,rootSegmentID:-1,parentFlushed:!1,pendingTasks:0,
forceClientRender:!1,completedSegments:[],byteSize:0,fallbackAbortableTasks:l,errorDigest:null,resources:new Set},q=tg(a,c.chunks.length,m,c.formatContext,!1,!1);c.children.push(q);c.lastPushedText=!1;var t=tg(a,0,null,c.formatContext,!1,!1);t.parentFlushed=!0;b.blockedBoundary=m;b.blockedSegment=t;a.resources.boundaryResources=m.resources;try{if(Dg(a,b,e,0),t.lastPushedText&&t.textEmbedded&&t.chunks.push(Kb),t.status=1,Eg(m,t),0===m.pendingTasks)break a}catch(n){t.status=4,m.forceClientRender=!0,
"object"===typeof n&&null!==n&&n.$$typeof===kf?(a.onPostpone(n.message),f="POSTPONE"):f=yg(a,n),m.errorDigest=f}finally{a.resources.boundaryResources=d?d.resources:null,b.blockedBoundary=d,b.blockedSegment=c}b=ug(a,null,g,d,q,l,b.keyPath,b.legacyContext,b.context,b.treeContext);a.pingedTasks.push(b)}return}if("object"===typeof d&&null!==d)switch(d.$$typeof){case Ye:d=d.render;Mf={};Nf=b;Sf=Rf=0;Tf=c;f=d(e,g);e=Zf(d,e,f,g);if(0!==Rf){d=b.treeContext;b.treeContext=Af(d,1,0);try{Y(a,b,null,e,0)}finally{b.treeContext=
d}}else Y(a,b,null,e,0);return;case af:d=d.type;e=Bg(d,e);Cg(a,b,c,d,e,g);return;case Ve:f=e.children;d=d._context;e=e.value;c=d._currentValue;d._currentValue=e;g=qf;qf=e={parent:g,depth:null===g?0:g.depth+1,context:d,parentValue:c,value:e};b.context=e;Y(a,b,null,f,0);a=qf;if(null===a)throw Error("Tried to pop a Context at the root of the app. This is a bug in React.");e=a.parentValue;a.context._currentValue=e===hf?a.context._defaultValue:e;a=qf=a.parent;b.context=a;return;case We:e=e.children;e=
e(d._currentValue);Y(a,b,null,e,0);return;case bf:f=d._init;d=f(d._payload);e=Bg(d,e);Cg(a,b,c,d,e,void 0);return}throw Error("Element type is invalid: expected a string (for built-in components) or a class/function (for composite components) but got: "+((null==d?d:typeof d)+"."));}}
...
n.status=1;Hg(q,m.blockedBoundary,n)}catch(C){$f();n.children.length=u;n.chunks.length=H;var F=C===Ff?Jf():C;if("object"===typeof F&&null!==F&&"function"===typeof F.then){var r=m.ping;F.then(r,r);m.thenableState=ag()}else{m.abortSet.delete(m);n.status=4;var O=void 0,P=q,L=m.blockedBoundary,B=F;"object"===typeof B&&null!==B&&B.$$typeof===kf?(P.onPostpone(B.message),O="POSTPONE"):O=yg(P,B);null===L?zg(P,B):(L.pendingTasks--,L.forceClientRender||(L.forceClientRender=!0,L.errorDigest=O,L.parentFlushed&&
...
var I=g.preloadChunks;for(f=0;f<I.length;f++)p(b,I[f]);I.length=0;var F=g.hoistableChunks;for(f=0;f<F.length;f++)p(b,F[f]);F.length=0;t&&null===n&&(p(b,mc),p(b,"head"),p(b,nc));Lg(a,b,d);a.completedRootSegment=null;uc(b,a.responseState)}else return;else if(0<a.pendingRootTasks)return;var r=a.resources,O=a.responseState;d=0;r.preconnects.forEach(ue,b);r.preconnects.clear();var P=O.preconnectChunks;for(d=0;d<P.length;d++)p(b,P[d]);P.length=0;r.fontPreloads.forEach(ue,b);r.fontPreloads.clear();r.highImagePreloads.forEach(te,
...
l)};f.addEventListener("abort",l)}}Pg(g)})};exports.version="18.3.0-experimental-98f3f14d2-20230818";
